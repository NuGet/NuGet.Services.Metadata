...
namespace NuGet.Services.AzureSearch.FunctionalTests
{
    public class V3RelevancyFunctionalTests : NuGetSearchFunctionalTestBase
    {
        ...
        public static IEnumerable<object[]> EnsureFirstResultsData()
        {
            ...
            yield return new object[] { "entityframework", new[] { "entityframework", "microsoft.entityframeworkcore" } };
            yield return new object[] { "entity framework", new[] { "microsoft.entityframeworkcore", "microsoft.entityframeworkcore.relational", "entityframework" } };
