    ...
    public class IndexOperationBuilderFacts
    {
        public class Autocomplete : Facts
        {
            ...
            public void BuildsSearchOperation()
            {
                ...
                ParametersBuilder.Verify(x => x.Autocomplete(AutocompleteRequest, It.IsAny<string>()), Times.Once);
            }
        }
        ...
        public class V3Search : SearchIndexFacts
        {
            ...
            public void CallsDependenciesForGetOperation()
            {
                ...
                ParametersBuilder.Verify(x => x.V3Search(It.IsAny<V3SearchRequest>(), It.IsAny<string>()), Times.Never);
            }
            ...
            public void CallsDependenciesForSearchOperation()
            {
                ...
                ParametersBuilder.Verify(x => x.V3Search(V3SearchRequest, It.IsAny<string>()), Times.Once);
            }
        }
        ...
        public class V2SearchWithSearchIndex : SearchIndexFacts
        {
            ...
            public void CallsDependenciesForGetOperation()
            {
                ...
                TextBuilder.Verify(x => x.Build(It.IsAny<ParsedQuery>()), Times.Never);
                ParametersBuilder.Verify(x => x.V2Search(It.IsAny<V2SearchRequest>(), It.IsAny<string>()), Times.Never);
            }
            ...
            public void CallsDependenciesForSearchOperation()
            {
                ...
                TextBuilder.Verify(x => x.ParseV2Search(V2SearchRequest), Times.Once);
                TextBuilder.Verify(x => x.Build(ParsedQuery), Times.Once);
                ParametersBuilder.Verify(x => x.V2Search(V2SearchRequest, It.IsAny<string>()), Times.Once);
            }
        }
        ...
        public abstract class Facts
        {
            ...
            public Facts()
            {
                ...
                TextBuilder
                    ...
                    .Returns(() => Text);
                ParametersBuilder
                    .Setup(x => x.Autocomplete(It.IsAny<AutocompleteRequest>(), It.IsAny<string>()))
                    .Returns(() => Parameters);
                ParametersBuilder
